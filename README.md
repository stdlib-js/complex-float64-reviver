...
```javascript
reviveComplex128 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float64-reviver@v0.0.3-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/complex-float64-reviver/actions/workflows/test.yml/badge.svg?branch=v0.0.3
[test-url]: https://github.com/stdlib-js/complex-float64-reviver/actions/workflows/test.yml?query=branch:v0.0.3
